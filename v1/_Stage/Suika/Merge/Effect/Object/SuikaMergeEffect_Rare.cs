...
{
    public class SuikaMergeEffect_Rare : SuikaMergeEffectBase
    {
        public override MonsterGrade Grade => MonsterGrade.Rare;
        
        [SerializeField] private SuikaMergeEffectDataSO_Rare dataSO;
